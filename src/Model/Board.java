...
public class Board {
    ...
    // UC-3.12, UC-3.35 (Trước khi phát triển): Đảo quyền đi qua lại giữa Người và Máy
    // UC-3.36 (Trước khi phát triển): Đảo quyền đi qua lại giữa Người và Máy
    ...
    // UC-3.5, UC-3.7, UC-3.31 (Trước khi phát triển): Tính toán số lượng quân cờ đối phương sẽ bị lật
    // UC-3.33 (Sau khi phát triển): Tính toán số lượng quân cờ đối phương sẽ bị lật
    ...
    // UC-3.8, UC-3.21 (Trước khi phát triển), UC-3.32 (Trước khi phát triển): Thực hiện đặt cờ và lật các quân bị kẹp trên bàn cờ
    // UC-3.22 (Sau khi phát triển), UC-3.34 (Sau khi phát triển): Thực hiện đặt cờ và lật các quân bị kẹp trên bàn cờ
    ...
    // UC-3.17, UC-3.19, UC-3.29 (Trước khi phát triển): Quét bàn cờ và lấy danh sách tất cả các vị trí đi hợp lệ
    // UC-3.30 (Sau khi phát triển): Quét bàn cờ và lấy danh sách tất cả các vị trí đi hợp lệ
    ...
    // UC-3.14, UC-3.37 (Trước khi phát triển): Kiểm tra điều kiện kết thúc ván (đầy bàn hoặc cả 2 mất lượt)
    // UC-3.38 (Sau khi phát triển): Kiểm tra điều kiện kết thúc ván (đầy bàn hoặc cả 2 mất lượt)
    ...
    // UC-3.16, UC-3.24 (Trước khi phát triển): Tính toán và trả về mảng điểm số hiện tại của 2 bên
    // UC-3.25 (Sau khi phát triển): Tính toán và trả về mảng điểm số hiện tại của 2 bên
    public int[] getScore() {
        int[] score = new int[2];
        int black = 0, white = 0;
        for (int i = 0; i < 8; i++) {
    ...
    // UC-3.20 (Trước khi phát triển): Sao chép trạng thái ma trận bàn cờ hiện tại sang một đối tượng Board độc lập để AI chạy thử giả định
    // UC-3.21 (Sau khi phát triển): Sao chép trạng thái ma trận bàn cờ hiện tại sang một đối tượng Board độc lập để AI chạy thử giả định
    public Board copy() {
    ...
    // UC-3.25 (Trước khi phát triển): Đếm số lượng góc bàn cờ (Corner) đã chiếm giữ
    // UC-3.26 (Sau khi phát triển): Đếm số lượng góc bàn cờ (Corner) đã chiếm giữ
    ...
    // UC-3.26 (Trước khi phát triển): Đếm số lượng quân cờ nằm trên các cạnh (Edge)
    // UC-3.27 (Sau khi phát triển): Đếm số lượng quân cờ nằm trên các cạnh (Edge)
    ...
    // UC-3.27 (Trước khi phát triển): Đếm số lượng ô nguy hiểm X-Square (cạnh góc)
    // UC-3.28 (Trước khi phát triển): Đếm số lượng ô nguy hiểm X-Square (cạnh góc)
    ...
    // UC-3.28 (Trước khi phát triển): Đếm số lượng ô nguy hiểm C-Square (kề góc)
    // UC-3.29 (Sau khi phát triển): Đếm số lượng ô nguy hiểm C-Square (kề góc)
